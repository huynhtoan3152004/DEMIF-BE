...
namespace Demif.Infrastructure.Migrations
{
    ...
    [Migration("20260214122837_AddBlogFeature")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Demif.Domain.Entities.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Demif.Domain.Entities.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Demif.Domain.Entities.PostLike", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Demif.Domain.Entities.Comment", b =>
                {
                    b.HasOne("Demif.Domain.Entities.Post", null)
                        .WithMany("Comments")
