...
{
    [Fact]
    public async Task ExecuteAsync_WeeklyPlanAlreadyPurchased_ReturnsConflict()
    {
        ...
        Assert.Contains("chỉ được đăng ký một lần", result.Error.Message, StringComparison.OrdinalIgnoreCase);
